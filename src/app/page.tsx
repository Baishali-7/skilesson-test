  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <Image
        ...
        alt="Aspen mountain peaks at dawn"
        fill
      ...
      >
        <path
          d="M0 500 L0 350 L120 280 L250 320 L380 200 L480 260 L580 150 L680 220 L780 100 L880 180 L980 120 L1080 200 L1180 160 L1280 230 L1380 180 L1440 220 L1440 500Z"
          fill="#1a2744"
        />
      </svg>
      ...
      >
        <path
          d="M0 400 L0 300 L100 260 L200 290 L320 180 L420 230 L520 160 L620 210 L720 130 L820 190 L920 150 L1020 220 L1120 170 L1220 240 L1340 200 L1440 250 L1440 400Z"
          fill="#162033"
        />
        {/* Snow caps */}
        <path
          d="M520 160 L490 185 L530 175 L560 185Z"
          fill="rgba(255,255,255,0.15)"
        />
        <path
          d="M720 130 L690 155 L730 145 L760 160Z"
          fill="rgba(255,255,255,0.15)"
        />
        <path
          d="M920 150 L895 172 L935 162 L955 175Z"
  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          World-class ski and snowboard lessons you can take from home.
          Learn technique, build confidence, and track your progress &mdash;
          so every day on the mountain counts.
        </motion.p>
        ...
        >
          Free 7-day trial &middot; Cancel anytime &middot; No equipment needed to start
        </motion.p>
      </div>
      ...
      <Reveal>
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-snow/50 sm:text-lg">
            ...
            for progression &mdash; whether you are clicking into skis for the first
            time or looking to conquer double blacks.
          </p>
        </div>
      </Reveal>
          ...
          <Reveal key={level.level} delay={i * 0.12}>
            ...
            >
              ...
              <div className="mt-6 flex items-center gap-3">
                ...
                <h3 className="font-heading text-2xl font-bold">{level.level}</h3>
              </div>

              {/* Topics */}
              <ul className="mt-6 space-y-3">
                {level.topics.map((topic) => (
                  <li key={topic} className="flex items-start gap-3 text-sm text-snow/60">
        ...
        <div>
          <Reveal>
            ...
            <p className="mt-4 max-w-lg text-base leading-relaxed text-snow/50 sm:text-lg">
              Skiing is a family sport. Our platform is designed from the
              ground up to make learning fun, safe, and accessible for every
              member of the family &mdash; from five-year-olds to grandparents.
            </p>
          </Reveal>
          {/* Family skiing photo */}
          <Reveal delay={0.15}>
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <Reveal delay={0.2}>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-snow/50 sm:text-lg">
            ...
            adapts to your pace, answers your questions, and keeps you
            motivated between lessons. That is what we are building.
          </p>
        </Reveal>
        ...
        <div>
          <Reveal>
            ...
            <p className="mt-4 max-w-lg text-base leading-relaxed text-snow/50 sm:text-lg">
              ...
              competition or resort experience. No amateurs. No shortcuts.
              The same instructors who train at Vail, Aspen, and Park City
              are now teaching you.
            </p>
          </Reveal>
        ...
        <div className="relative mx-auto max-w-4xl overflow-hidden rounded-3xl">
          ...
          <div className="relative px-8 py-16 text-center sm:px-16 sm:py-24">
            ...
            <p className="mx-auto mt-4 max-w-xl text-base text-snow/50 sm:text-lg">
              Join thousands of students who showed up to the mountain
              prepared, confident, and ready to ride. Your journey starts
              with a single click.
            </p>
